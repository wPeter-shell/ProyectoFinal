   ...
   private void crearMenu() {
      ...
      itemDefinirNumCitas.addActionListener(e -> {
          if (usuarioLogueado instanceof Administrador) {
              ...
              JOptionPane.showMessageDialog(
                  this,
                  "Solo un m�dico puede modificar el n�mero de citas.",
                  "Acceso denegado",
      ...
      itemModificarCita.addActionListener(e -> {
          if (usuarioLogueado instanceof Secretaria) {
              new ModificarCita(this, usuarioLogueado).setVisible(true);  // CORRECCIÓN
          } else {
              JOptionPane.showMessageDialog(
                  Principal.this,
