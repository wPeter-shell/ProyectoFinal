...
public class Principal extends JFrame {
   ...
   private void crearMenu() {
      ...
      menuAdmin = new JMenu("Administraci贸n");
      menuAdmin.setFont(new Font("Segoe UI", Font.PLAIN, 14));
      menuBar.add(menuAdmin);

      itemRegistrarMedico = new JMenuItem("Registrar m茅dico");
      ...
      itemDefinirNumCitas = new JMenuItem("Modificar n艧 de citas por d铆a");
      ...
      itemGuardarArchivos.addActionListener(new ActionListener() {
      	public void actionPerformed(ActionEvent e) {
      		...
      		JOptionPane.showMessageDialog(null, "Guardado Correctamente.", "脡xito", JOptionPane.INFORMATION_MESSAGE);
      	}
      });
      ...
      itemRespaldo.addActionListener(new ActionListener() {
    	   public void actionPerformed(ActionEvent e) {
    	      ...
    	      try {
    	         ...
    	         JOptionPane.showMessageDialog(
    	            Principal.this,
    	            "Error en la comunicaci髇 con el servidor.",
    	            "Error de conexi髇",
    	            JOptionPane.ERROR_MESSAGE
    	         );
    	      } finally {
   ...
   private void crearDashboardMinimal() {
	   ...
	   JLabel lblSubtitulo = new JLabel("Sistema de gesti贸n cl铆nica");
